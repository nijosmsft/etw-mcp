  ...
  "mcpServers": {
    "etw-trace-analyzer": {
      ...
      "args": ["run", "--no-project", "--with",
               "https://github.com/nijosmsft/etw-mcp/releases/download/v0.8.2/etw_mcp-0.8.2-py3-none-any.whl",
...
uv run --no-project --with https://github.com/nijosmsft/etw-mcp/releases/download/v0.8.2/etw_mcp-0.8.2-py3-none-any.whl python -m etw_analyzer.server
```
...
```json
{
  "mcpServers": {
    "etw-trace-analyzer": {
      "type": "stdio",
      "command": "uv",
      "args": ["run", "--no-project", "--with", "https://github.com/nijosmsft/etw-mcp/releases/download/v0.8.2/etw_mcp-0.8.2-py3-none-any.whl", "python", "-m", "etw_analyzer.server"],
      "env": {
        "_NT_SYMBOL_PATH": "srv*C:\\symbols*https://msdl.microsoft.com/download/symbols"
      }
    }
...
Invoke-WebRequest `
  -Uri "https://github.com/nijosmsft/etw-mcp/releases/download/v0.8.2/etw-extract.exe" `
