...
EVENT_DOTNET_SPAWN = "dotnet.spawn"
EVENT_DOTNET_RESULT = "dotnet.result"
EVENT_DOTNET_CHILD_EXIT = "dotnet.child_exit"
EVENT_DOTNET_CACHE_VALIDATE = "dotnet.cache_validate"
EVENT_DOTNET_AGGREGATION_START = "dotnet.aggregation_start"
EVENT_DOTNET_AGGREGATION_DONE = "dotnet.aggregation_done"
EVENT_DOTNET_CACHE_PROMOTE = "dotnet.cache_promote"
...
KNOWN_EVENTS: frozenset[str] = frozenset({
    ...
    EVENT_DOTNET_SPAWN,
    EVENT_DOTNET_RESULT,
    EVENT_DOTNET_CHILD_EXIT,
    EVENT_DOTNET_CACHE_VALIDATE,
    EVENT_DOTNET_AGGREGATION_START,
    EVENT_DOTNET_AGGREGATION_DONE,
    EVENT_DOTNET_CACHE_PROMOTE,
    EVENT_NATIVE_SPAWN,
